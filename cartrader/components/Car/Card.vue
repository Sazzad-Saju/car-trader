...
<template>
  <div class="relative shadow border border-gray-200 w-full overflow-hidden mb-5 cursor-pointer h-[200px]" >
    <img class="absolute w-7 right-5 top-2  z-20 " :src="favored ? heartFilled : heartOutline" alt="" @click="favored = !favored" />
